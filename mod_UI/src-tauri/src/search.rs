...
#[path = "search_cache.rs"] mod search_cache;
#[path = "search_cran.rs"] mod search_cran;
#[path = "search_bioc.rs"] mod search_bioc;
#[path = "search_github.rs"] mod search_github;
#[path = "search_http.rs"] mod search_http;
#[path = "search_result.rs"] mod search_result;
...
#[cfg(test)] #[path = "search_tests_1.rs"] mod search_tests_1;
#[cfg(test)] #[path = "search_tests_2.rs"] mod search_tests_2;
